...
namespace Finbourne.Configuration.Sdk.Extensions
{
    ...
    public class ApiConfigurationBuilder
    {
        ...
        {
            { "TokenUrl", "tokenUrl" },
            { "BaseUrl", "finbourne-configurationUrl" },
            { "ClientId", "clientId" },
        ...
        {            
            var apiConfig = new ApiConfiguration
            {
                ...
                BaseUrl = Environment.GetEnvironmentVariable("FBN_FINBOURNE-CONFIGURATION_API_URL") ?? Environment.GetEnvironmentVariable("fbn_finbourne-configuration_api_url"),

...
namespace Finbourne.Configuration.Sdk.Api
{
    ...
    public interface IApplicationMetadataApiSync : IApiAccessor
    {
        ...
        Finbourne.Configuration.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource> ListAccessControlledResourcesWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IApplicationMetadataApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Configuration.Sdk.Client.ApiResponse<ResourceListOfAccessControlledResource>> ListAccessControlledResourcesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class ApplicationMetadataApi : IApplicationMetadataApi
    {
        ...
        /// <returns></returns>
        public ApplicationMetadataApi(Finbourne.Configuration.Sdk.Client.Configuration configuration)
        {
        ...
        public ApplicationMetadataApi(Finbourne.Configuration.Sdk.Client.ISynchronousClient client, Finbourne.Configuration.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Configuration.Sdk.Client.IReadableConfiguration configuration)
        {
